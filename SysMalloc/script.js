...
function login(e) {
  ...
  fetch(
    `http://10.194.56.68:5000/user_login?name1=${name}&password1=${pswrd2}`,
    {
      headers: {
...
function signup(e) {
  ...
  fetch(`http://10.194.56.68:5000/user_signup`, {
    headers: {
      "Content-Type": "application/json",
    },
    method: "POST",
...
function ask_ques(e) {
  ...
  fetch(`http://10.194.56.68:5000/question`, {
    headers: {
      "Content-Type": "application/json",
    },
    method: "POST",
...
if (
  window.location.href == "http://127.0.0.1:5500/userpage_from_allusers.html"
) {
  var user_req = localStorage.getItem("get_user");
  fetch(`http://10.194.56.68:5000/user?name1=${user_req}`, {
    headers: {
      "Content-Type": "application/json",
    },
    method: "GET",
...
if (
  ...
  // console.log(user);
  fetch(
    `http://10.194.56.68:5000/question_title?title=${q_req}&username=${user}`,
    {
      headers: {
        "Content-Type": "application/json",
      },
...
function edit_profile(e) {
  ...
  fetch(`http://10.194.56.68:5000/user?name1=${username}`, {
    headers: {
      "Content-Type": "application/json",
    },
    method: "PUT",
...
function delete_ques() {
  ...
  fetch(`http://10.194.56.68:5000/question_title?quesid=${questionid}`, {
    headers: {
      "Content-Type": "application/json",
    },
    method: "DELETE",
...
if (window.location.href == "http://127.0.0.1:5500/all_users_page.html") {
  ...
  const url = `http://10.194.56.68:5000/users_list`;
  fetch(url, {
    headers: {
      "Content-Type": "application/json",
    },
...
if (window.location.href == "http://127.0.0.1:5500/all_questions_page.html") {
  //how to write this for every user URL SPECIFICICATION
...
function follow(user) {
  ...
  if (x.innerHTML == "Follow") {
    ...
    fetch("http://10.194.56.68:5000/follow", {
      headers: {
        "Content-Type": "application/json",
      },
      method: "POST",
...
function post_ans_func(e) {
  ...
  console.log(body);
  fetch("http://10.194.56.68:5000/answers", {
    headers: {
      "Content-Type": "application/json",
    },
    method: "POST",
...
if (
  ...
  "http://127.0.0.1:5500/users_profile_page_followers.html"
) {
  var user = localStorage.getItem("username");
  const url = `http://10.194.56.68:5000/followers?name1=${user}`;
  fetch(url, {
    headers: {
      "Content-Type": "application/json",
    },
...
if (
  window.location.href ==
  "http://127.0.0.1:5500/users_profile_page_following.html"
) {
  var username = localStorage.getItem("username");
  const url = `http://10.194.56.68:5000/followees?name1=${username}`;
  fetch(url, {
    headers: {
      "Content-Type": "application/json",
    },
