...
function login(e) {
  ...
  fetch(
    `http://10.17.50.18:5000/user_login?name1=${name}&password1=${pswrd2}`,
    {
      headers: {
...
function signup(e) {
  ...
  fetch(`http://10.17.50.18:5000/user_signup`, {
    headers: {
      "Content-Type": "application/json",
    },
    method: "POST",
...
function ask_ques(e) {
  ...
  fetch(`http://10.17.50.18:5000/question`, {
    headers: {
      "Content-Type": "application/json",
    },
    method: "POST",
...
if (
  window.location.href == "http://10.17.50.18:4242/userpage_from_allusers.html"
) {
  var user_req = localStorage.getItem("get_user");
  fetch(`http://10.17.50.18:5000/user?name1=${user_req}`, {
    headers: {
      "Content-Type": "application/json",
    },
    method: "GET",
...
if (
  ...
  "http://10.17.50.18:4242/particular_question_page.html"
) {
  var q_req = localStorage.getItem("ques_id");
  var user = localStorage.getItem("username");
  // console.log(user);
  fetch(
    `http://10.17.50.18:5000/question_title?title=${q_req}&username=${user}`,
    {
      headers: {
        "Content-Type": "application/json",
      },
    ...
    .then((data) => {
      ...
      var number_of_upvotes = document.querySelector(".number_of_upvotes");
      number_of_upvotes.innerHTML = data.upvotes;
...
function edit_profile(e) {
  ...
  fetch(`http://10.17.50.18:5000/user?name1=${username}`, {
    headers: {
      "Content-Type": "application/json",
    },
    method: "PUT",
...
function delete_ques() {
  ...
  fetch(`http://10.17.50.18:5000/question_title?quesid=${questionid}`, {
    headers: {
      "Content-Type": "application/json",
    },
    method: "DELETE",
...
if (window.location.href == "http://10.17.50.18:4242/all_users_page.html") {
  //how to write this for every user URL SPECIFICICATION
  const url = `http://10.17.50.18:5000/users_list`;
  fetch(url, {
    headers: {
      "Content-Type": "application/json",
    },
...
if (window.location.href == "http://10.17.50.18:4242/all_questions_page.html") {
  //how to write this for every user URL SPECIFICICATION
  const url = "http://10.17.50.18:5000/question"; // api url daalna hai
  fetch(url, {
    headers: {
      "Content-Type": "application/json",
    },
    ...
    .then((data) => {
      ...
      data.forEach((question) => {
        ...
        var votes = clone_div.querySelector(".ques_votes_output");
        ...
        votes.innerHTML = question.upvotes;
...
// if (window.location.href == "http://10.17.50.18:4242/users_page.html") {
//   //how to write this for every user URL SPECIFICICATION
...
function follow(user) {
  ...
  if (x.innerHTML == "Follow") {
    ...
    fetch("http://10.17.50.18:5000/follow", {
      headers: {
        "Content-Type": "application/json",
      },
      method: "POST",
...
function post_ans_func(e) {
  ...
  console.log(body);
  fetch("http://10.17.50.18:5000/answers", {
    headers: {
      "Content-Type": "application/json",
    },
    method: "POST",
...
if (
  window.location.href ==
  "http://10.17.50.18:4242/users_profile_page_followers.html"
) {
  var user = localStorage.getItem("username");
  const url = `http://10.17.50.18:5000/followers?name1=${user}`;
  fetch(url, {
    headers: {
      "Content-Type": "application/json",
    },
...
if (
  window.location.href ==
  "http://10.17.50.18:4242/users_profile_page_following.html"
) {
  var username = localStorage.getItem("username");
  const url = `http://10.17.50.18:5000/followees?name1=${username}`;
  fetch(url, {
    headers: {
      "Content-Type": "application/json",
    },
...
if (
  window.location.href == "http://10.17.50.18:4242/users_profile_page_feed.html"
) {
  const url = "";
  fetch(url, {
    headers: {
...
function search_bar(e) {
  e.preventDefault();
  var search_form = document.querySelector(".search_bar_form");
  var search_body = search_form.search.value;
  console.log("search_function_called");
  localStorage.setItem("search_query", search_body);
  window.location.href = "query_page.html";
}

if (window.location.href == "http://10.17.50.18:4242/query_page.html") {
  var search_query = localStorage.getItem("search_query");
  const url = `http://10.17.50.18:5000/find_question?query=${search_query}`;
  fetch(url, {
    headers: {
      "Content-Type": "application/json",
    },
    ...
    .then((data) => {
      console.log(data);
      const original_div = document.querySelector(".particular_query_ques");

      const parent_element = original_div.parentElement;
      data.forEach((question) => {
        var clone_div = original_div.cloneNode(true);
        clone_div.style.display = "flex";
        // var total_questions = clone_div.querySelector(".total_ques_output");
        var title = clone_div.querySelector(".q_link");
        var downvotes = clone_div.querySelector(".ques_downvotes_output");
        var upvotes = clone_div.querySelector(".ques_upvotes_output");
...
function changeImage(id) {
  if (id == 1) {
    if (
      document.getElementById("upvoteimg").src.split("/")[4] ==
      "upvoteonclick.png"
    ) {
      document.getElementById("upvoteimg").src = "assets/upvote.png";
    } else {
      document.getElementById("upvoteimg").src = "assets/upvoteonclick.png";
      var question_id = localStorage.getItem("ques_id");
      body = { questionid: question_id };
      fetch("http://10.17.50.18:5000/upvote", {
        headers: {
          "Content-Type": "application/json",
        },
        method: "POST",
    ...
    document.getElementById("downvoteimg").src = "assets/downvote.png";
  } else if (id == 2) {
    document.getElementById("upvoteimg").src = "assets/upvote.png";
    if (
      document.getElementById("downvoteimg").src.split("/")[4] ==
      "downvoteonclick.png"
    ) {
      document.getElementById("downvoteimg").src = "assets/downvote.png";
    } else {
      var question_id = localStorage.getItem("ques_id");
      body = { questionid: question_id };
      fetch("http://10.17.50.18:5000/downvote", {
        headers: {
          "Content-Type": "application/json",
        },
        method: "POST",
        ...
        .catch((error) => console.log(error));
      document.getElementById("downvoteimg").src = "assets/downvoteonclick.png";
    }
  }
}
function changeImage2(id) {
  if (id == 1) {
    if (
      document.getElementById("upvoteimgans").src.split("/")[4] ==
      "upvoteonclick.png"
    ) {
      document.getElementById("upvoteimgans").src = "assets/upvote.png";
    } else {
      document.getElementById("upvoteimgans").src = "assets/upvoteonclick.png";
    }
    document.getElementById("downvoteimgans").src = "assets/downvote.png";
  } else if (id == 2) {
    document.getElementById("upvoteimgans").src = "assets/upvote.png";
    if (
      document.getElementById("downvoteimgans").src.split("/")[4] ==
      "downvoteonclick.png"
    ) {
      document.getElementById("downvoteimgans").src = "assets/downvote.png";
    } else {
      document.getElementById("downvoteimgans").src =
        "assets/downvoteonclick.png";
    }
  }
}
